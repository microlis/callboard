...
SECRET_KEY = 'django-insecure-)n_9e4hj!&0e3=1w8ybf-1kjef=dvo=f2any$_k$7u-yt&@-q$'
...
EMAIL_HOST_USER = 'xxx@gmail.com' # ваше имя пользователя, например если ваша почта user@yandex.ru, то сюда надо писать user, иными словами, это всё то что идёт до собаки
